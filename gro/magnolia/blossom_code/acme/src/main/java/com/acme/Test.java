...
import com.acme.config.BlossomServletConfiguration;

/**
 * This class manages the lifecycle of the acme module. It starts and stops Spring when Magnolia starts up and
 ...
 */
public class Test extends BlossomModuleSupport implements ModuleLifecycle {

    public void start(ModuleLifecycleContext moduleLifecycleContext) {
        if (moduleLifecycleContext.getPhase() == ModuleLifecycleContext.PHASE_SYSTEM_STARTUP) {

            // Using Spring java config
            super.initRootWebApplicationContext(TestConfiguration.class);
