...
app.controller('mainController', function ($scope, $http, $window, $filter, $sce, Util) {
	...
	var request = 	$window.localStorage.getItem('candidateUser') || null;
	...
	$scope.loadTemplate = function(){
		var url = $scope.baseApiUrl + '/ws/rest/templateService/template1/candidateName/'+candidate+'/token/test';
		$http.get(url).
	...
	var url = $scope.baseApiUrl + '/ws/rest/resourceService/getUserByEmailAddressAndSocialMediaType/socialMediaType/'+request.socialMediaType+'/token/test?emailAddress='+candidateEmail;
	...
	$scope.deleteSchool = function(school) {
		...
		var url = $scope.baseApiUrl + '/ws/rest/templateService/template1/candidateName/'+candidate+'/delete/schoolId/'+schoolId+'/token/{token}';
	...
	$scope.saveSchool = function(school) {
		...
		var url = $scope.baseApiUrl + '/ws/rest/templateService/template1/school/candidateName/'+candidate+'/token/test';
...
$scope.saveTemplate1 = function() {
	...
	//	var role = window.encodeURIComponent(company.role);
		var url = $scope.baseApiUrl + '/ws/rest/templateService/template1/candidateName/'+candidate+'/delete/companyId/'+companyId+'/token/test';
	...
	console.log(JSON.stringify(company));
		...
		var url = $scope.baseApiUrl + '/ws/rest/templateService/template1/company/candidateName/'+candidate+'/token/test';
	...
	$scope.deleteActivity = function(activity) {
		...
		var url = $scope.baseApiUrl + '/ws/rest/templateService/template1/candidateName/'+candidate+'/delete/leadershipId/'+leadershipId+'/token/test';
	...
	$scope.saveActivity = function(activity) {
		...
		var url = $scope.baseApiUrl + '/ws/rest/templateService/template1/leadershipActivity/candidateName/'+candidate+'/token/test';
	...
	$scope.generateProfile = function(){
		var ul = $scope.baseApiUrl + '/ws/rest/templateService/generatePdfForTemplate1/token/test';
		$http({
		    url: ul,
		    dataType: 'json',
		    method: 'POST',
...
app.controller( 'pdfController',  function($scope, $http, $window, $filter, $sce) {
	...
	$scope.content = $window.localStorage.getItem("pdfUrl") || null;
