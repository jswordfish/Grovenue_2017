...
app.controller('toolsUploadController', function ($scope, $http, $window, $filter, fileUpload, Util) {
	...
	$scope.uploadFile = function(){
               ...
               var url = $scope.baseApiUrl + '/ws/rest/digitalToolService/uploadDigitalToolsExcel/token/test';
