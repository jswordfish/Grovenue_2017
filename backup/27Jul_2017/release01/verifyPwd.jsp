...
<html lang="en">
      <head>
         <link rel="stylesheet" href="app/css/bootstrap.min.css">
            <link rel="stylesheet" href="app/css/custom_v2.css?dummy=dummy">
     ...
     <link rel="stylesheet" href="app/css/alert.css">
	...
	<script src="app/js/bootbox.js"></script>
            ...
            <script src="app/js/commonServices.js"></script>
	     <script src="app/js/verifyController.js?dummy=dummy"></script>
...
<p>
<h2>
	<a href="index.html" >Click here and Proceed</a>
</h2>
